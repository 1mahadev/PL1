...
if __name__ == "__main__" :
    ...
    status_message_handler = MessageHandler(
        status_message_f,
        filters=Filters.command(["status@MahadevKiJai_Bot"]) & Filters.chat(chats=AUTH_CHANNEL)
    )
    ...
    exec_message_handler = MessageHandler(
        exec_message_f,
        filters=Filters.command(["exec@MahadevKiJai_Bot"]) & Filters.chat(chats=AUTH_CHANNEL)
    )
    ...
    upload_document_handler = MessageHandler(
        upload_document_f,
        filters=Filters.command(["upload@MahadevKiJai_Bot"]) & Filters.chat(chats=AUTH_CHANNEL)
    )
    ...
    save_thumb_nail_handler = MessageHandler(
        save_thumb_nail,
        filters=Filters.command(["savethumbnail@MahadevKiJai_Bot"]) & Filters.chat(chats=AUTH_CHANNEL)
    )
    app.add_handler(save_thumb_nail_handler)
    #
    clear_thumb_nail_handler = MessageHandler(
        clear_thumb_nail,
        filters=Filters.command(["clearthumbnail@MahadevKiJai_Bot"]) & Filters.chat(chats=AUTH_CHANNEL)
    )
